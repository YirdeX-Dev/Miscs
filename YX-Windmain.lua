...
Accent = Color3.fromHex("#18181b"),        -- 强调色 / 主色调
Dialog = Color3.fromHex("#161616"),        -- 对话框背景色
Outline = Color3.fromHex("#00FFFF"),       -- 边框/轮廓颜色（青色）
Text = Color3.fromHex("#FFFFFF"),          -- 文字颜色（白色）
Placeholder = Color3.fromHex("#FFFFFF"),   -- 占位符文字颜色（灰色）
Background = Color3.fromHex("#101010"),    -- 主背景色（深灰/黑）
Button = Color3.fromHex("#00FFFF"),        -- 按钮背景色（青色）
Icon = Color3.fromHex("#00FFFF"),          -- 图标颜色（青色）
Toggle = Color3.fromHex("#00FFFF"),        -- 开关/切换按钮颜色（青色）
Slider = Color3.fromHex("#00FFFF"),        -- 滑块颜色（青色）
Checkbox = Color3.fromHex("#00FFFF"),      -- 复选框颜色（青色）

PanelBackground = Color3.fromHex("#FFFFFF"),       -- 面板背景色（白色）
PanelBackgroundTransparency = 0.95,                 -- 面板背景透明度（95%透明）

SliderIcon = Color3.fromHex("#00FFFF"),     -- 滑块图标颜色（青色）
Primary = Color3.fromHex("#00FFFF"),        -- 主要按钮/强调色（青色）

LabelBackground = Color3.fromHex("#000000"),        -- 标签背景色（黑色）
LabelBackgroundTransparency = 0.83,                 -- 标签背景透明度（83%透明）

ElementBackground = Color3.fromHex("#2A2A2C"),      -- 元素背景色
ElementBackgroundTransparency = 0,                  -- 元素背景透明度（完全不透明）  
},
golden={
Name="金色",
...
Dialog=Color3.fromHex"#1A0033",     
Outline=Color3.fromHex"#FF00FF",   
Text=Color3.fromHex"#FFFFFF",      
Placeholder=Color3.fromHex"#9933FF", 
Background=Color3.fromHex"#0D001A",  
Button=Color3.fromHex"#6600CC",   
Icon=Color3.fromHex"#FF00FF",      
Toggle=Color3.fromHex"#00FFFF",   
...
Accent=Color3.fromHex"#228B22",     
Dialog=Color3.fromHex"#0A1F0A",    
Outline=Color3.fromHex"#98FB98",   
Text=Color3.fromHex"#FFFFFF",      
Placeholder=Color3.fromHex"#2E8B57", 
Background=Color3.fromHex"#132813",  
Button=Color3.fromHex"#3CB371",    
Icon=Color3.fromHex"#32CD32",      
Toggle=Color3.fromHex"#00FF7F",   
Slider=Color3.fromHex"#228B22",    
Checkbox=Color3.fromHex"#32CD32",  
},
SpringFestival={
Name="Spring Festival",

Accent=Color3.fromHex"#FF0000",      
Dialog=Color3.fromHex"#8B0000",     
Outline=Color3.fromHex"#FFFF00",     
Text=Color3.fromHex"#FFFFFF",       
Placeholder=Color3.fromHex"#FF8C00", 
Background=Color3.fromHex"#4A0000",  
Button=Color3.fromHex"#DC143C",    
Icon=Color3.fromHex"#FFD700",        
Toggle=Color3.fromHex"#FF4500",      
Slider=Color3.fromHex"#FF0000",     
Checkbox=Color3.fromHex"#FFFF00",    
},
Dark={
Name="Dark",
                    
Accent=Color3.fromHex"#1E90FF",      
Dialog=Color3.fromHex"#0A192F",    
Outline=Color3.fromHex"#87CEEB",   
Text=Color3.fromHex"#FFFFFF",       
Placeholder=Color3.fromHex"#4682B4", 
Background=Color3.fromHex"#13263D",  
Button=Color3.fromHex"#4169E1",    
Icon=Color3.fromHex"#00BFFF",      
Toggle=Color3.fromHex"#00CED1",     
...
Accent=Color3.fromHex"#00FF9D",      
Dialog=Color3.fromHex"#0D0221",     
Outline=Color3.fromHex"#FF2A6D",     
Text=Color3.fromHex"#FFFFFF",        
Placeholder=Color3.fromHex"#05D9E8", 
Background=Color3.fromHex"#01012B", 
Button=Color3.fromHex"#005678",      
Icon=Color3.fromHex"#FF2A6D",        
Toggle=Color3.fromHex"#00FF9D",      
Slider=Color3.fromHex"#05D9E8",      
Checkbox=Color3.fromHex"#D1F7FF",    
},
Galaxy={
Name="Galaxy",

Accent=Color3.fromHex"#9B5DE5",      
Dialog=Color3.fromHex"#1D0B38",      
Outline=Color3.fromHex"#F15BB5",     
Text=Color3.fromHex"#FFFFFF",        
Placeholder=Color3.fromHex"#00BBF9", 
Background=Color3.fromHex"#0F0626",  
Button=Color3.fromHex"#5A189A",     
Icon=Color3.fromHex"#7209B7",       
Toggle=Color3.fromHex"#F15BB5",      
Slider=Color3.fromHex"#00BBF9",      
Checkbox=Color3.fromHex"#9B5DE5",    
},
Light={
Name="Light",
